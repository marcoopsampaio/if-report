...
```{r}
  ...
  data1_stage1_xlsx_2014$Rank2 <- 1:nrecords
...
```{r}
  data1_stage2_xlsx_2014_panels<-rbind(data1_stage2_xlsx_2014_hum,data1_stage2_xlsx_2014_soc,data1_stage2_xlsx_2014_nat,data1_stage2_xlsx_2014_env,data1_stage2_xlsx_2014_env,data1_stage2_xlsx_2014_med,data1_stage2_xlsx_2014_eng,data1_stage2_xlsx_2014_sci)
```
...
```{r}
  ...
  for (i in 1:nrecords4) {
    ...
    data_2014$Status4[rowpos] <- data1_stage2_xlsx_2014_panels[i,"Status4"]
...
Now we retrieve information from each panel but we first concatenate in a big dataframe
```{r}
  data2_stage2_xlsx_2014_panels<-rbind(data2_stage2_xlsx_2014_hum,data2_stage2_xlsx_2014_soc,data2_stage2_xlsx_2014_nat,data2_stage2_xlsx_2014_env,data2_stage2_xlsx_2014_env,data2_stage2_xlsx_2014_med,data2_stage2_xlsx_2014_eng,data2_stage2_xlsx_2014_sci)
```
And finally we re-distribute the values
```{r}
  ...
  for (i in 1:nrecords5) {
    ...
    data_2014$Status5[rowpos] <- data2_stage2_xlsx_2014_panels[i,"Status5"]
...
Now we retrieve information from each panel but we first concatenate in a big dataframe
```{r}
  data3_stage2_xlsx_2014_panels<-rbind(data3_stage2_xlsx_2014_hum,data3_stage2_xlsx_2014_soc,data3_stage2_xlsx_2014_nat,data3_stage2_xlsx_2014_env,data3_stage2_xlsx_2014_env,data3_stage2_xlsx_2014_med,data3_stage2_xlsx_2014_eng,data3_stage2_xlsx_2014_sci)
```
And finally we re-distribute the values
```{r}
  ...
  for (i in 1:nrecords6) {
    ...
    data_2014$Status6[rowpos] <- data3_stage2_xlsx_2014_panels[i,"Status6"]
...
```{r}
  ...
  data1_stage1_xlsx_2015$Rank2 <- 1:nrecords
...
Now we retrieve information from each panel but we first concatenate in a big dataframe
```{r}
  data1_stage2_xlsx_2015_panels<-rbind(data1_stage2_xlsx_2015_hum,data1_stage2_xlsx_2015_soc,data1_stage2_xlsx_2015_nat,data1_stage2_xlsx_2015_env,data1_stage2_xlsx_2015_env,data1_stage2_xlsx_2015_med,data1_stage2_xlsx_2015_eng,data1_stage2_xlsx_2015_sci)
```
And finally we re-distribute the values
```{r}
  ...
  for (i in 1:nrecords3) {
    ...
    data_2015$Status3[rowpos] <- data1_stage2_xlsx_2015_panels[i,"Status3"]
